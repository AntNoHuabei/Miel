...
export interface ProviderModelLite { model: string; label: string; custom: boolean; multimodal: boolean; contextWindow?: number }
export interface ProviderModelInputLite { model: string; label?: string; custom?: boolean; multimodal?: boolean; contextWindow?: number }
export interface DiscoveredModelLite { id: string; status: string; reasoning: ReasoningSpecLite; multimodal: boolean; supportsTools: boolean; contextWindow?: number }
export interface ModelOptionLite { providerId: number; providerName: string; kind: string; model: string; label: string; custom: boolean; multimodal: boolean; contextWindow?: number; isDefault: boolean }
...
export interface CatalogModelLite { id: string; label: string; reasoning: ReasoningSpecLite; multimodal: boolean; contextWindow?: number }
